...
function ChatEmptyImage({desc, sendMessage}) {
  ...
  return(
    <View style={styles.chatEmpty} >
      <View style={{ ...styles.containerChatEmpty,  borderColor: theme.colors.tertiary,}} >
        <Text style={{fontFamily: "InterBold", fontSize: 16, color: theme.colors.secondary}} >
          {image}
        </Text>
        <Text style={{fontFamily: 'InterBold', fontSize: 18, marginTop: 10, color: theme.colors.tertiary}} >
          Prompt
        </Text>
        <Pressable
