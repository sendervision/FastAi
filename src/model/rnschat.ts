...
class RsnChat {
   ...
   * @returns
   */
  async prodia(prompt: string, negative_prompt: string, model: string):Promise<any> {
    try {
      if (!prompt) {
  ...
  async absolutebeauty(
    prompt: string,
    negative_prompt: string
  ): Promise<"No prompt provided." | "No negative_prompt provided." | Image | any> {
    try {
      if (!prompt) {
        return "No prompt provided.";
      }
   ...
   */
  async dalle(prompt: string): Promise<"No prompt provided." | Image | any> {
    try {
      if (!prompt) {
        return "No prompt provided.";
      }
   ...
   * @returns {Promise<"No prompt provided." | Image>}
   */
  async icon(prompt: string): Promise<"No prompt provided." | Image | any> {
    try {
      if (!prompt) {
        return "No prompt provided.";
      }
   ...
   * @returns {Promise<"No prompt provided." | Image>}
   */
  async anime(prompt: string): Promise<"No prompt provided." | Image | any> {
    try {
      if (!prompt) {
        return "No prompt provided.";
      }
